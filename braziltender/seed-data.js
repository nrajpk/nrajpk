...
<div class="page" id="index-page">
  ...
  <div class="page-content">
    ...
    <div class="toc-container" contenteditable="false">
      ...
      <a href="#part-b3" class="toc-sublink">↳ B3. Technical Specifications – Item 2 (CAV)</a><br>
      <a href="#part-b4" class="toc-sublink">↳ B4. Acceptance Tests (ATP) & Testing Committee</a><br>
      <a href="#part-b5" class="toc-sublink">↳ B5. Visual References & Evidence</a><br>
...
<div class="page" id="part-b3">
  <div class="header">
    <div class="logo-container"><img src="meva.png" alt="MEVA Logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';"><span style="display:none; font-size:20px; color:var(--brand-color); font-weight:800;">MEVA</span></div>
  </div>
  <div class="page-content">
    <div class="main-heading" style="margin-top: 10px; font-size: 13px;">B3. Technical Specifications – Item 2 (CAV)</div>
...
<div class="page">
  ...
  <div class="page-content">
    <div class="main-heading" style="font-size: 13px;">B3. Technical Specifications – Item 2 (Cont.)</div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr><td>2.16 (a-e)</td><td>Unmarked Lighting Assy: Front primary (inside windshield), Rear primary (inside rear window), Secondary (behind grille). 2 magnetic emblems.</td><td class="col-exec col-exec-tbd">TBD</td><td></td><td></td></tr>
      </tbody>
    </table>
    <div class="doc-controls-wrapper" contenteditable="false"><button class="doc-control" onclick="addRow(this)">+ Add Row</button><button class="doc-control" onclick="removeRow(this)">- Remove Row</button></div>
...
<div class="page" id="part-b4">
  ...
  <div class="page-content">
    <div class="vol-identifier">PART B - TECHNICAL REQUISITES</div>
    <div class="main-heading">B4. Acceptance Tests (ATP) & Testing Committee</div>
...
<div class="page" id="part-b5">
  <div class="header">
    <div class="logo-container"><img src="meva.png" alt="MEVA Logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';"><span style="display:none; font-size:20px; color:var(--brand-color); font-weight:800;">MEVA</span></div>
  </div>
  <div class="page-content">
    <div class="vol-identifier">PART B - TECHNICAL REQUISITES</div>
    <div class="main-heading">B5. Visual References & Evidence (APC & CAV)</div>
...
<div class="page" id="final-declarations">
  ...
  <div class="page-content">
    ...
    <div id="annex2" class="main-heading">Compliance with Annex I-I & I-J – Responsibilities of Committees</div>
